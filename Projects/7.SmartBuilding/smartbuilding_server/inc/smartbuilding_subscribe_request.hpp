...
{
public:
    SmartBuildingSubscribeRequest(const std::string& a_requestSenderID, const Event::EventType& a_interestedEventType, const SubscriptionLocation& a_subscriptionLocation)
