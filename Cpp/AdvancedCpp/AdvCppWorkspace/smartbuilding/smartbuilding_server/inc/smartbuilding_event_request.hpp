...
{
public:
    SmartBuildingEventRequest(const std::string& a_requestSenderID, infra::TCPSocket::BytesBufferProxy a_eventDataBuffer) : SmartBuildingRequest(a_requestSenderID), m_eventDataBuffer(a_eventDataBuffer) {}
