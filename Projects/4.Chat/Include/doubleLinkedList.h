#ifndef __DOUBLELINKDLIST_H__
#define __DOUBLELINKDLIST_H__
...
typedef enum ListResult {
	...
	LIST_NO_ELEMENT_ERROR				/** Empty list*/
 ...
 * @retval LIST_UNINITIALIZED_ERROR if the list is not initialized
 * @retval LIST_NULL_ELEMENT_ERROR  if _item is NULL
 * @retval LIST_NO_ELEMENT_ERROR  if list is empty
 */
 ...
 *
 * @params _list : A previously created List ADT returned via ListCreate
 * @returns number of elements or zero if empty or not initialized.
 */
size_t ListSize(const List* _list);


#endif /* __DOUBLELINKDLIST_H__ */
