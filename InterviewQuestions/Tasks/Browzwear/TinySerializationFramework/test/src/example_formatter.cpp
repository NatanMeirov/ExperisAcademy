...
std::string ExampleFormatter::Serialize(const ser_fw::Types::TypeToParamsMapPair& a_typedMappedParams) const
{
...
ser_fw::Types::TypeToParamsMapPair ExampleFormatter::Deserialize(const std::string& a_formattedStr) const
{
    ser_fw::Types::TypeToParamsMapPair typedParamsMap;
