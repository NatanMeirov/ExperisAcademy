 ...
 * @param[in] _ptrFuncLessThen: A Less Than (<) comparison callback function, to be used to compare two elements, cannot be NULL
 * @return Heap* - on success / NULL - on failure
 *
 * @warning Allocating and freeing the underlying Vector is the user responsibility
 * @warning If underlying Vector has NULL values in it: the behaviour of the Heap and the Heap functions are undefined
 ...
 * @param[in] _element: An element to insert to the Heap, cannot be NULL
