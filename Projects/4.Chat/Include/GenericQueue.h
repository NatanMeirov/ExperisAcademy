 ...
 * @param[in] _itemToInsert: The item to insert to the end of the Queue, cannot be NULL
 ...
 *
 * @warning If _itemToInsert is NULL: function will fail and return QUEUE_UNINITIALIZED_ERROR
 */
 ...
 * @param[out] _pItem: A pointer to a variable that used to return the wanted item value by reference
 * @return QueueResult - success or error status code
 * @retval QUEUE_SUCCESS on success
 * @retval QUEUE_UNINITIALIZED_ERROR on error - given pointer is NULL
