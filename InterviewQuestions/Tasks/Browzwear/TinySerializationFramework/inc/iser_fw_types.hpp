#ifndef SF_ISER_FW_TYPES_HPP
#define SF_ISER_FW_TYPES_HPP
...
struct Types
{
    ...
    // TypeToParamsMapPair type: represents a {string:value} pair - of a type info (as string), and a matched ParamsMap of a concrete object from that type.
    using TypeToParamsMapPair = std::pair<std::string, ParamsMap>;
