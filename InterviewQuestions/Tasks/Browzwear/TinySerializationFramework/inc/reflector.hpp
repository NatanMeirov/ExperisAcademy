...
// Concept of FactoryPtrT: must be std::shared_ptr<ISerFwObjFactory<RetPtrT>> or ISerFwObjFactory<RetPtrT>* type.
// Concept of RetPtrT: must be std::shared_ptr<ISerFwObj> or ISerFwObj*.
...
private:
    ...
    {
    public:
        explicit ReflectionProxy(FactoryPtrT a_reflectedFactoryPtr)
        : m_reflectedFactoryPtr(a_reflectedFactoryPtr)
        {
        }
    ...
    private:
        FactoryPtrT m_reflectedFactoryPtr;
    };
...
{
    return m_reflectedFactoryPtr->Create();
}
