 ...
 * Note: To use the server's logger - make sure to define: USE_SERVER_LOGGER constant (preprocessor's command: #define USE_SERVER_LOGGER)
 ...
 * @param[in] _receivedMessagesBufferSize: The wanted size of the received messages (buffer size), used to store the received message in a heap allocated buffer of the given size, must be at least 1024
