 ...
 * @return iterator pointing at the list's beginning, if _list is NULL- return NULL
 */
 ...
 * @return an iterator pointing at the list's end, if _list is NULL- return NULL
 */
